...
struct CountdownRepositoryTests {
    ...
    func migratesNullableCreationDate() async throws {
        ...
        let fixtureURL = try #require(Bundle.module.url(forResource: "pre-created-at", withExtension: "sql"))
        ...
        #expect(loaded[0].createdAt == Date(timeIntervalSinceReferenceDate: 0))
